...
class ArticlesListAdapter(val articlesList: Collection<ArticleDetailDomain>, val itemClick: (ArticleDetailDomain) -> Unit) : RecyclerView.Adapter<ArticlesListAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View, val itemClick: (ArticleDetailDomain) -> Unit) : RecyclerView.ViewHolder(view) {
        fun bindArticle(article: ArticleDetailDomain) {
            with(article) {
